...
extern int cplayer_color;
extern int cplayer_level;

void cplayer_make_move(void);

// Find best move for player and put it to *move.
// Return true if such move was found, or false otherwise.
// Game position is given in global board.h structs
int cplayer(int player, move_t* move);
