...
#define NES_BUTTON_UP           BUTTON_UP
#define NES_BUTTON_DOWN         BUTTON_DOWN
#define NES_BUTTON_A            BUTTON_PLAYPAUSE
#define NES_BUTTON_B            BUTTON_VOL_UP
#define NES_BUTTON_START        BUTTON_BOTTOMLEFT
#define NES_BUTTON_SELECT       BUTTON_BOTTOMRIGHT
#define NES_BUTTON_MENU         BUTTON_VOL_DOWN
